...
export const DrivesPermissionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listPermissions: async (driveId: string, itemId: string, $filter?: string, $select?: Set<ListPermissionsSelectEnum>, $count?: boolean, $top?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'driveId' is not null or undefined
...
export const DrivesPermissionsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listPermissions(driveId: string, itemId: string, $filter?: string, $select?: Set<ListPermissionsSelectEnum>, $count?: boolean, $top?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CollectionOfPermissionsWithAllowedValues>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listPermissions(driveId, itemId, $filter, $select, $count, $top, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const DrivesPermissionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        listPermissions(driveId: string, itemId: string, $filter?: string, $select?: Set<ListPermissionsSelectEnum>, $count?: boolean, $top?: number, options?: RawAxiosRequestConfig): AxiosPromise<CollectionOfPermissionsWithAllowedValues> {
            return localVarFp.listPermissions(driveId, itemId, $filter, $select, $count, $top, options).then((request) => request(axios, basePath));
        },
        /**
         * Set the password of a sharing permission.  Only the `password` property can be modified this way. 
         * @summary Set sharing link password
...
export const DrivesRootApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listPermissionsSpaceRoot: async (driveId: string, $filter?: string, $select?: Set<ListPermissionsSpaceRootSelectEnum>, $count?: boolean, $top?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'driveId' is not null or undefined
...
export const DrivesRootApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listPermissionsSpaceRoot(driveId: string, $filter?: string, $select?: Set<ListPermissionsSpaceRootSelectEnum>, $count?: boolean, $top?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CollectionOfPermissionsWithAllowedValues>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listPermissionsSpaceRoot(driveId, $filter, $select, $count, $top, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const DrivesRootApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        listPermissionsSpaceRoot(driveId: string, $filter?: string, $select?: Set<ListPermissionsSpaceRootSelectEnum>, $count?: boolean, $top?: number, options?: RawAxiosRequestConfig): AxiosPromise<CollectionOfPermissionsWithAllowedValues> {
            return localVarFp.listPermissionsSpaceRoot(driveId, $filter, $select, $count, $top, options).then((request) => request(axios, basePath));
        },
        /**
         * Set the password of a sharing permission.  Only the `password` property can be modified this way. 
         * @summary Set sharing link password for the root item of a drive
